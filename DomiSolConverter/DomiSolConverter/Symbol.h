...
public:
	Symbol(int lineNum, int barNum, int orderNum, int x, int y);
	int getLineNum();
	int getBarNum();
	int getOrderNum();
};
...
public:
	Note(int lineNum, int barNum, int orderNum, int x, int y): Symbol(lineNum, barNum, orderNum, x, y) {}
	int getFlag();
	bool getIsEmptyHead();
	bool getDot();
	bool getIsWholeNote();
...
private:
	string nonNoteType;
public:
	NonNote(int lineNum, int barNum, int orderNum, string nonNoteType, int x, int y) : Symbol(lineNum, barNum, orderNum, x, y) { this->nonNoteType = nonNoteType; }
